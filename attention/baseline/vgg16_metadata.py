...
import pandas as pd
import scipy.io
from ..utils.paths import path_metadata, path_results

df = pd.read_csv(path_results/'base_results.csv', index_col=0)
meta = scipy.io.loadmat(path_metadata/'meta.mat')
ilsvrc2wnid = {}
wnid2name = {}
wnid2desc = {}
