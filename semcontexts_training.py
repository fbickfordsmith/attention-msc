...
attention_model.save_weights(path_weights+'initialised_model_semcontexts.h5')

for i in range(40):
    print(f'Training on context {i}')
    path_context = path_data + f'context{i:02}'
    attention_model.load_weights(path_weights+'initialised_model_semcontexts.h5')
